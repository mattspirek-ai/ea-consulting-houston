...
| `docs/athena-format-spec.md` | Section-by-section format spec translating Athena's paid landing page layout into our tokens and content rules (basis for concept D) | Hand-authored; edit here |
...
| `site-concepts/{a-editorial-boutique,b-conversion-landing,c-pricing-first,d-athena-format}/index.html` | Four complete single-file website prototypes (different structure and register) built from `docs/build-brief.md`; see `site-concepts/README.md` for the comparison and recommended combination | Hand-built; edit here |
